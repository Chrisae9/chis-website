    ...
    <div className="flex flex-wrap gap-2">
      {links.map((link) => (
        <a
          ...
          className="inline-flex items-center gap-1.5 px-2.5 py-1 text-sm rounded-md bg-glass-light text-gray-700 dark:text-gray-100 border border-white/20 dark:border-gray-300/20 hover:border-gray-300 dark:hover:border-gray-700 shadow-elegant hover:shadow-card transition-all duration-200 hover:scale-105"
        >
