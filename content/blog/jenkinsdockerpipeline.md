---
title: Configuring a Docker Jenkins Pipeline
date: 2022-03-02 05:02:43
category: tutorials
draft: false
---

![Jenkins Docker](images/jenkinsdocker.jpg)

## Summary

- Jenkins is running through a Docker Container on my personal website at https://jenkins.chis.dev.
- There is a connected [Jenkins Agent](https://github.com/Chrisae9/devops-class/blob/docker-jenkins-pipeline/agent/Dockerfile) that is running in a privileged docker container to leverage Docker in Docker.
...
- The build will run this [Jenkinsfile](https://github.com/Chrisae9/devops-class/blob/docker-jenkins-pipeline/Jenkinsfile) which will:
  - Build the [Dockerfile](https://github.com/Chrisae9/devops-class/blob/docker-jenkins-pipeline/Dockerfile) image that will be used to containerize the website located under [website/](https://github.com/Chrisae9/devops-class/tree/docker-jenkins-pipeline/website)
...
[Here](https://github.com/Chrisae9/devops-class/blob/docker-jenkins-pipeline/agent/Dockerfile) is the Dockerfile for the custom agent.
...
[Here](https://github.com/Chrisae9/devops-class/blob/docker-jenkins-pipeline/Dockerfile) is the Dockerfile for building the gatsby website.
...
[Here](https://github.com/Chrisae9/devops-class/blob/docker-jenkins-pipeline/Jenkinsfile) is the main Jenkinsfile.
